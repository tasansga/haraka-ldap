...
var _set_up = function (done) {
    ...
    this.plugin = new fixtures.plugin('aliases_ldap');
    this.plugin.cfg = { main : { } };
    this.connection = fixtures.connection.createConnection();
    this.connection.transaction = { };
    this.plugin.init_aliases_ldap(function(){}, {
        notes : {
...
exports.register = {
    ...
    'set master and child hooks to gain pool access' : function(test) {
        ...
        test.equals('init_aliases_ldap', this.plugin.register_hook.args[0][1]);
        test.equals('init_aliases_ldap', this.plugin.register_hook.args[1][1]);
...
exports.init_aliases_ldap = {
    ...
    'call next' : function(test) {
        ...
        plugin.init_aliases_ldap(callback, { notes : { ldappool : {} } });
    },
    'no pool' : function(test) {
        ...
        plugin.init_aliases_ldap(callback, { notes : { } });
    }
};
